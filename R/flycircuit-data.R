...
#' 
#' @details The flycircuit database seems to have at least 3 unique identifiers
#'   for neurons. These are: \itemize{
#'   
...
#'   }
#'   
#'   Although the neuron \code{Name} is generally what is reported in
#'   publications the \code{gene_name} seems to widely used and is what
#'   connected to the confocal image file name. The \code{_seg001} suffix in
#'   gene_names refers to the segmentation of individual neurons from stacks
#'   that might contain multiple labelled neurons after MARCM.
#'   
#' @name fcidtable
