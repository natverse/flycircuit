# Getting help with flycircuit

Thanks for using flycircuit. We're sorry if you're having trouble, but don't worry,
...
* Search GitHub for [_issues_ with the flycircuit package](https://github.com/natverse/flycircuit/issues).
...
* If you need to report a *new* bug:
  please [file an issue](https://github.com/natverse/flycircuit/issues/new).
* If you're not sure:
